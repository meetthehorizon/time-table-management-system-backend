...
public class SubjectController {
  ...
  public ResponseEntity<Subject> updateSubject(@PathVariable Long id,
    ...
    Optional.ofNullable(updateSubjectDto.getName())
        .ifPresent(existingSubject::setName);
    Optional.ofNullable(updateSubjectDto.getCode())
        .ifPresent(existingSubject::setCode);
