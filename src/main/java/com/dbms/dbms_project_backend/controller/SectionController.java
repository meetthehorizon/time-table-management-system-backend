...
public class SectionController {
  ...
  public ResponseEntity<Section> save(@Valid @RequestBody AddSectionDto addSectionDto) {
    ...
    Section section = new Section()
        .setSchoolId(addSectionDto.getSchoolId())
        .setClassLevel(addSectionDto.getClassLevel())
        .setRunningYear(addSectionDto.getRunningYear())
  ...
  public ResponseEntity<Section> update(@PathVariable Long id,
    ...
    Optional.ofNullable(updateSectionDto.getSection())
        .ifPresent(existingSection::setSection);
    Optional.ofNullable(updateSectionDto.getRunningYear())
        .ifPresent(existingSection::setRunningYear);
    Optional.ofNullable(updateSectionDto.getClassLevel())
        .ifPresent(existingSection::setClassLevel);
    Optional.ofNullable(updateSectionDto.getSchoolId())
        .ifPresent(existingSection::setSchoolId);
