...
public class EnrollmentController {
    ...
    public ResponseEntity<Enrollment> save(@Valid @RequestBody AddEnrollmentDto addEnrollmentDto) {
        ...
        Enrollment enrollment = new Enrollment().setStudentId(addEnrollmentDto.getStudentId())
    ...
    public ResponseEntity<Enrollment> update(@PathVariable Long id,
        ...
        Optional.ofNullable(updateEnrollmentDto.getStudentId()).ifPresent(existingEnrollment::setStudentId);
        Optional.ofNullable(updateEnrollmentDto.getSectionId()).ifPresent(existingEnrollment::setSectionId);
