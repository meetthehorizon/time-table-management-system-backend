...
public class TeacherReqController {
  ...
  public ResponseEntity<List<TeacherReq>> findAll() {
    ...
    if (currentUser.getRoles().contains(Role.ROLE_ADMIN)) {
      ...
      return ResponseEntity.ok(
          teacherReqService.findBySchoolId(employee.getSchoolId()));
    }
  }

  @GetMapping("/school/{schoolId}")
  public ResponseEntity<List<TeacherReq>> findBySchoolId(@PathVariable Long schoolId) {
    logService.logRequestAndUser("/teacher-req/school/" + schoolId, "GET");
  ...
  public ResponseEntity<TeacherReq> save(@Valid @RequestBody AddTeacherReqDto addTeacherReqDto) {
    ...
    teacherReq.setSchoolId(addTeacherReqDto.getSchoolId())
        ...
        .setSubjectId(addTeacherReqDto.getSubjectId())
        .setTeacherId(addTeacherReqDto.getTeacherId());
  ...
  public ResponseEntity<TeacherReq> update(@PathVariable Long id,
    ...
    Optional.ofNullable(updateTeacherReqDto.getSchoolId())
        .ifPresent(existingTeacherReq::setSchoolId);
    Optional.ofNullable(updateTeacherReqDto.getPosition())
        .ifPresent(existingTeacherReq::setPosition);
    Optional.ofNullable(updateTeacherReqDto.getSubjectId())
        .ifPresent(existingTeacherReq::setSubjectId);
    Optional.ofNullable(updateTeacherReqDto.getTeacherId())
        .ifPresent(existingTeacherReq::setTeacherId);
