...
public class SubjectReqController {
  ...
  public ResponseEntity<SubjectReq> createSubjectReq(@Valid @RequestBody AddSubjectReqDto addSubjectReq) {
    ...
    subjectReq.setSubjectId(addSubjectReq.getSubjectId())
        .setNumLab(addSubjectReq.getNumLab())
        .setClassLevel(addSubjectReq.getClassLevel())
        .setNumLecture(addSubjectReq.getNumLecture())
        .setAttendanceCriteria(addSubjectReq.getAttendanceCriteria())
        .setTeacherPosition(
            Position.fromString(addSubjectReq.getTeacherPosition()));
  ...
  @PutMapping("/{id}")
  public ResponseEntity<SubjectReq> updateSubjectReq(
    ...
    Optional.ofNullable(updateSubjectReqDto.getSubjectId())
        .ifPresent(existingSubjectReq::setSubjectId);
    Optional.ofNullable(updateSubjectReqDto.getNumLab())
        .ifPresent(existingSubjectReq::setNumLab);
    Optional.ofNullable(updateSubjectReqDto.getClassLevel())
        .ifPresent(existingSubjectReq::setClassLevel);
    Optional.ofNullable(updateSubjectReqDto.getNumLecture())
        .ifPresent(existingSubjectReq::setNumLecture);
    Optional.ofNullable(updateSubjectReqDto.getAttendanceCriteria())
        .ifPresent(existingSubjectReq::setAttendanceCriteria);
    Optional.ofNullable(updateSubjectReqDto.getTeacherPosition())
        .ifPresent(teacherPosition -> existingSubjectReq.setTeacherPosition(
            Position.fromString(teacherPosition)));
